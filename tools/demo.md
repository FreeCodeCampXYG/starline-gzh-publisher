...
克隆或下载后，打开 `tools/index.html` 即可看到所有工具。无需安装任何依赖。
...
| MD → 微信排版 | `md-to-wechat.html` | Markdown 转微信富文本，44 主题，自动格式修复 |
...
支持 44 种主题风格，从经典到星痕推荐。内置 Markdown 过滤层，自动修复格式问题，不支持的格式转 SVG 图片。
...
这个工具是独立的，每写完一次内容，可以做一个归档，把草稿和封面图一起归档到你指定的位置。
